            ...
            .map(section => {
                const items = section.items
                    ...
                    .map(item => {
                        ...
                        // Non-approvers land on their own leave list, not the manage-all view
                        if (item.id === 'leaves' && !userPermissions.includes(P.LEAVE_APPROVE)) {
                            route = '/leaves/myLeaves'
                        }
                        // Non-managers land on their own payroll, never the teacher-picker admin view
                        if (item.id === 'payroll' && !userPermissions.includes(P.PAYROLL_MANAGE)) {
                            route = '/payroll/myPayroll'
                        }
                        return {
                            ...item,
                            route,
