...
const ClassesSubjectsTab = () => {
    return (
        <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Classes & Subjects</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <select className="block w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm appearance-none bg-white">
...
export default ClassesSubjectsTab;