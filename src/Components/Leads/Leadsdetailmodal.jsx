...
import { X, Phone, School, Users, CalendarClock, CheckCircle2 } from "lucide-react";
import LeadStatusBadge from "./LeadsStatusbadge.jsx";
import {
    LEAD_STATUS,
    LEAD_STATUS_LABELS,
    NEXT_STATUS_OPTIONS,
    STUDENT_STRENGTH_LABELS,
} from "../../Constants/StringConstants/LeadsConstants.js";
import { formatDateTime, toDateInput, toDateTimeLocalInput } from "./Leadformatters.js";
...
const LeadDetailsModal = ({ lead, onClose, onUpdated }) => {
