...
const MainRoutes = () => {
  return (
    <Routes>
      ...
      {/* Super Admin Routes */}
      <Route path="/superadmin/manageUsers" element={<ManageAllUsers />} />
      <Route path="/superadmin/editUser/:id" element={<EditSysUser />} />
      <Route path="/superadmin/addNewUser" element={<AddnewSystemUser />} />
