...
import { Plus, Calendar, Search, ChevronDown, Edit2, Trash2, FileSignature, Hourglass, X, Filter, Edit, Pen } from 'lucide-react';
...
export default function HolidayManagement() {
    ...
    const handleEditClick = async (id) => {
        try {
            ...
            // Calculate academic year from the holiday date
    ...
    const cardsArray = [
        ...
        {
            IconName: Hourglass,
            keyName: "Upcoming Holidays",
            val: statistics.upcomingHolidays,
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-4 md:py-6">
                    ...
                    <div className="flex flex-col sm:flex-row w-fit items-start sm:items-center justify-between gap-3">
                        ...
                        <div className="relative w-full sm:w-auto">
                            <select
                                ...
                                className="w-full sm:w-30 md:w-28 px-2 py-2.5 md:py-3 pr-10 bg-white border border-gray-300 rounded-lg text-gray-700 text-base md:text-lg font-medium text-center focus:ring-2 focus:ring-blue-500 focus:border-transparent hover:border-gray-400 transition-all appearance-none cursor-pointer"
                            >
                ...
                {/* Next Holiday */}
                {nextHoliday && (
                    <div className="bg-linear-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 p-4 md:p-5 mb-4 md:mb-6">
                        <p className="text-xs font-bold text-blue-600 bg-blue-100 w-fit py-1 px-2.5 rounded-full uppercase tracking-wide mb-3">
                            Next Holiday
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4 md:gap-6 text-sm">
                            <div>
                                <span className="text-gray-600 font-medium text-xs uppercase tracking-wide">Date</span>
                                <p className="text-gray-900 font-semibold mt-1 text-sm md:text-base">
                                    {new Date(nextHoliday.holidayDate).toDateString()}
                                </p>
                            </div>
                            <div>
                                <span className="text-gray-600 font-medium text-xs uppercase tracking-wide">Type</span>
                                <p className="text-gray-900 font-semibold mt-1 text-sm md:text-base">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-4 md:mb-6">
                    ...
                    <div className={`${showFilters ? 'grid' : 'hidden lg:grid'} grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 lg:gap-4`}>
                        ...
                        <div className="sm:col-span-2 lg:col-span-4">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm md:text-base text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white hover:border-gray-300 transition-all"
                                />
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-3">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="w-full px-3 md:px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm md:text-base text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white hover:border-gray-300 transition-all appearance-none cursor-pointer pr-10"
                                >
                        ...
                        <div className="hidden lg:block lg:col-span-3 lg:order-4"></div>
                        ...
                        <div className="lg:col-span-3 lg:order-5">
                            ...
                            <input
                                ...
                                className="w-full px-3 md:px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm md:text-base text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-transparent focus:bg-white hover:border-gray-300 transition-all"
                            />
                        </div>

                        {/* To Date */}
                        <div className="lg:col-span-3 lg:order-6">
                        ...
                        {(searchTerm || holidayType || fromDate || toDate) && (
                            <div className="sm:col-span-2 lg:col-span-6 lg:order-7 flex items-end lg:justify-end">
                                <button
                                    onClick={clearFilters}
                                    className="w-full lg:w-auto flex items-center justify-center gap-2 px-4 py-2.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all"
                                >
                                    <X className="w-4 h-4" />
                                    Clear Filters
                                </button>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    {loading && (
                        <div className="px-4 py-10 text-center text-gray-500">
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <span className="text-sm md:text-base">Loading holidays...</span>
                            </div>
                        </div>
                    )}
                    ...
                    {!loading && holidays.length === 0 && (
                        <div className="px-4 py-10 text-center text-gray-500 text-sm md:text-base">
                            No holidays found
                        </div>
                    )}

                    {/* Holidays Display - Responsive */}
                    {!loading && holidays.length > 0 && (
                        <>
                            {/* Desktop Table */}
                            <div className="hidden md:block overflow-x-auto">
                                <table className="w-full">
                                    <thead className="bg-gray-50 border-b border-gray-200">
                                        <tr>
                                            <th className="px-4 lg:px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Holiday Name</th>
                                            <th className="px-4 lg:px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wide">Date</th>
                                            <th className="px-4 lg:px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wide">Type</th>
                                            <th className="px-4 lg:px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wide hidden lg:table-cell">Description</th>
                                            <th className="px-4 lg:px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wide">Actions</th>
                                        </tr>
                                    </thead>
