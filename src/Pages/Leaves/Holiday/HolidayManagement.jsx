...
export default function HolidayManagement() {
  ...
  const parseApiError = (err, fallback) => {
    ...
    } catch (e) {console.error('Failed to parse error message', e);}
  ...
  const handleCreateHoliday = async (data) => {
    try {
      ...
      toast.success(`${data.holidayName} ${HOLIDAY_TOAST_MESSAGES.createSuccessSuffix}`);
      setOpenCreateHoliday(false);
      await refreshHolidayList();
    } catch (error) {
      console.error('Failed to create holiday', error);
      toast.error(parseApiError(error, HOLIDAY_TOAST_MESSAGES.createFailedDefault));
    } finally {
  ...
  const handleEditClick = async (id) => {
    try {
      ...
      toast.error(HOLIDAY_TOAST_MESSAGES.loadDetailsFailed);
    }
  };
  ...
  const handleEditHoliday = async (data) => {
    try {
      ...
      toast.success(HOLIDAY_TOAST_MESSAGES.updateSuccess);
      ...
      toast.error(parseApiError(err, HOLIDAY_TOAST_MESSAGES.updateFailedDefault));
    } finally {
      setSubmitLoader(false);
    }
  };
  ...
  const handleDeactivate = async (holidayId) => {
    try {
      ...
      await refreshHolidayList();
      toast.success(HOLIDAY_TOAST_MESSAGES.deactivateSuccess);
    } catch (error) {
      console.error('Failed to deactivate holiday', error);
      toast.error(HOLIDAY_TOAST_MESSAGES.deactivateFailed);
    } finally {
      setTogglingId(null);
    }
  };
  ...
  const cardsArray = [
    {
      ...
      keyName: HOLIDAY_TEXT.statCards.totalActive,
    ...
    },
    {
      ...
      keyName: HOLIDAY_TEXT.statCards.national,
    ...
    {
      IconName: CalendarClock,
      keyName: HOLIDAY_TEXT.statCards.religious,
    ...
    {
      IconName: CalendarClock,
      keyName: HOLIDAY_TEXT.statCards.regional,
    ...
    <div className="bg-blue-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-4 md:py-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 md:mb-6 gap-3">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">
              {HOLIDAY_TEXT.pageTitle}
            </h1>
            <p className="text-xs sm:text-sm text-gray-500 mt-0.5">
              {HOLIDAY_TEXT.pageSubtitle} {academicYear}
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            <div className="flex items-center gap-2 border border-gray-200 bg-white rounded-lg px-3 py-2 text-sm text-gray-700 font-medium shadow-sm flex-1 sm:flex-none">
              <span className="text-gray-500 font-normal whitespace-nowrap">
                {HOLIDAY_TEXT.academicYearLabel}
              </span>
            ...
            >
              ...
              <span className="hidden xs:inline">{HOLIDAY_TEXT.buttons.addHoliday}</span>
              <span className="xs:hidden">{HOLIDAY_TEXT.buttons.addShort}</span>
            </button>
          </div>
        </div>
        ...
        <HolidayComponentCard
          ...
          title={HOLIDAY_TEXT.modals.createTitle}
          subtitle={HOLIDAY_TEXT.modals.createSubtitle}
          mode="create"
        ...
        <HolidayComponentCard
          ...
          title={HOLIDAY_TEXT.modals.editTitle}
          subtitle={HOLIDAY_TEXT.modals.editSubtitle}
          mode="edit"
          loaderIsTrue={submitLoader}
          academicYears={lovAcademicYears}
          academicYearsLoading={academicYearsLoading}
            ...
            <div className="flex justify-between flex-col lg:flex-row bg-linear-to-r from-blue-100 via-indigo-200 to-purple-200 rounded-xl border border-white shadow-md shadow-gray-50 hover:shadow-md hover:shadow-gray-100 p-4 md:p-5 mb-4 md:mb-6">
              <div className="z-4">
                <p className="text-xs font-medium text-gray-600 bg-blue-50 w-fit py-1 px-2.5 rounded-full uppercase tracking-wide mb-3">
                  {HOLIDAY_TEXT.nextHoliday.badge}
                </p>
              ...
              <div className="z-4 flex xl:justify-center lg:items-center flex-wrap gap-4 md:gap-6 text-sm px-2">
                <div>
                  <span className="text-gray-700 font-medium text-xs uppercase tracking-wide">
                    {HOLIDAY_TEXT.nextHoliday.typeLabel}
                  </span>
                ...
                <div>
                  <span className="text-gray-700 font-medium text-xs uppercase tracking-wide">
                    {HOLIDAY_TEXT.nextHoliday.dateLabel}
                  </span>
                  <p className="text-gray-900 font-semibold mt-1 text-sm md:text-base">
        ...
        <div className="bg-white/50 rounded-xl shadow-sm border border-gray-200 p-3 md:p-4 mb-4 md:mb-6">
          ...
          <div className="flex justify-between items-center lg:hidden mb-3">
            <h3 className="text-sm font-semibold text-gray-900">
              {HOLIDAY_TEXT.filters.sectionTitle}
            </h3>
            <button
            ...
            >
              ...
              {showFilters ? HOLIDAY_TEXT.filters.hideLabel : HOLIDAY_TEXT.filters.showLabel}
            </button>
          </div>
          ...
          <div className={`${showFilters ? 'flex' : 'hidden lg:flex'} flex-col lg:flex-row items-end gap-3`}>
            ...
            <div className="w-full lg:flex-[2]">
              <label className="block text-xs font-medium text-gray-600 mb-1.5">
                {HOLIDAY_TEXT.filters.searchLabel}
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={HOLIDAY_TEXT.filters.searchPlaceholder}
            ...
            <div className="w-full lg:flex-[1.5]">
              <label className="block text-xs font-medium text-gray-600 mb-1.5">
                {HOLIDAY_TEXT.filters.holidayTypeLabel}
              </label>
              <div className="relative">
                <select
                  value={holidayType}
                ...
                >
                  <option value="">{HOLIDAY_TEXT.filters.allTypesOption}</option>
                  {HOLIDAY_TEXT.filters.typeOptions.map((opt) => (
            ...
            <div className="w-full lg:flex-[1.2]">
              <label className="block text-xs font-medium text-gray-600 mb-1.5">
                {HOLIDAY_TEXT.filters.fromDateLabel}
              </label>
              <input
                type="date"
                value={fromDate}
            ...
            <div className="w-full lg:flex-[1.2]">
              <label className="block text-xs font-medium text-gray-600 mb-1.5">
                {HOLIDAY_TEXT.filters.toDateLabel}
              </label>
              <input
                type="date"
                value={toDate}
                    ...
                    <td colSpan="5" className="py-16 text-center">
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <p className="text-sm font-medium text-gray-500">
                          {HOLIDAY_TEXT.states.noHolidaysDesktop}
                        </p>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr key={holiday.id} className="hover:bg-gray-50/80 transition-colors">
                    ...
                    <td className="px-4 py-3.5 align-middle">
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        >
                          {holiday.isActive
                            ? HOLIDAY_TEXT.status.active
                            : HOLIDAY_TEXT.status.inactive}
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-3.5 align-middle">
                      <div className="flex items-center gap-1.5">
                        <button
                          ...
                          title={HOLIDAY_TEXT.buttons.editHolidayTip}
                        >
                        ...
                        {holiday.isActive && (
                          <button
                            ...
                            title={HOLIDAY_TEXT.buttons.markInactiveTip}
                          ...
                          >
                            ...
                            <span className="whitespace-nowrap">
                              {togglingId === holiday.id
                                ? HOLIDAY_TEXT.buttons.saving
                                : HOLIDAY_TEXT.buttons.inactive}
                            </span>
                          </button>
                        )}
                      </div>
              ...
              <div className="text-start py-8">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-gray-600 text-sm">
                    {HOLIDAY_TEXT.states.loadingHolidays}
                  </span>
                </div>
              </div>
            )}
              ...
              <div className="py-16 text-center">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="text-sm font-semibold text-gray-700">
                    {HOLIDAY_TEXT.states.noHolidaysMobile}
                  </p>
                </div>
              </div>
            )}
                    ...
                    <div className="flex justify-between items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-1.5 mb-1">
                          ...
                          <span className={`text-[11px] ${holiday.isActive
                      ...
                      <div className="flex flex-col gap-2 items-end flex-shrink-0">
                        ...
                        {holiday.isActive && (
                          ...
                          >
                            ...
                            <span>
                              {togglingId === holiday.id
                                ? HOLIDAY_TEXT.buttons.savingShort
                                : HOLIDAY_TEXT.buttons.inactive}
                            </span>
                          </button>
                        )}
          ...
          {!loading && holidays.length > 0 && (
            <div className="flex flex-col sm:flex-row justify-between items-center px-4 md:px-6 py-3 border-t border-gray-200 gap-3">
              <p className="text-xs text-gray-500 text-center sm:text-left">
                {HOLIDAY_TEXT.pagination.showingPrefix}{' '}
                {Math.min(page * size + 1, totalElements)}{' '}
                &ndash;{' '}
                {Math.min((page + 1) * size, totalElements)}{' '}
                {HOLIDAY_TEXT.pagination.showingOf}{' '}
                {totalElements}{' '}
                {HOLIDAY_TEXT.pagination.showingEntries}
              </p>
