...
function EditTeachersDetails() {
    ...
    function handle_updateDetails(e) {
        ...
        // Find the index of the teacher in the array
        const teacherIndex = allTeachers.findIndex(t => t.id === id);
    ...
    return (
        <div className='outer flex flex-col bg-gray-100 h-full p-11 lg:p-8'>
