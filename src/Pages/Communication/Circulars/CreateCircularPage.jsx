...
export default function CreateCircularPage() {
  ...
  const handleSubmit = async (asDraft = false) => {
    ...
    showToast('success', asDraft ? COMMUNICATION_CONSTS.CREATE_CIRCULAR_TOAST.DRAFT_SAVED : COMMUNICATION_CONSTS.CREATE_CIRCULAR_TOAST.SUBMITTED);
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-5 items-start">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-2.5 pt-1">
            ...
            >
              <Save size={14} /> {COMMUNICATION_CONSTS.CREATE_CIRCULAR_TEXT.SAVE_DRAFT}
            </button>
            <button
