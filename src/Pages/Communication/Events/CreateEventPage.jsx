...
export default function CreateEventPage() {
  ...
  const handleSubmit = async (asDraft = false) => {
    ...
    showToast('success', asDraft ? CREATE_EVENT_TOAST.DRAFT_SAVED : CREATE_EVENT_TOAST.PUBLISHED);
        ...
        <div className="space-y-4">
          ...
          <FormCard title={CREATE_EVENT_TEXT.TARGET_RECIPIENTS}>
            <div className="space-y-4">
              ...
              {/* Broadcast groups */}
              <Field label={CREATE_EVENT_TEXT.BROADCAST_LABEL} error={errors.targets}>
              ...
              <Field label={CREATE_EVENT_TEXT.CLASS_SECTION_LABEL}>
                <div className="relative">
                  <select
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-2.5 pt-1">
            ...
            >
              ...
              {submitting ? CREATE_EVENT_TEXT.PUBLISHING : CREATE_EVENT_TEXT.PUBLISH}
            </button>
          </div>
        </div>
