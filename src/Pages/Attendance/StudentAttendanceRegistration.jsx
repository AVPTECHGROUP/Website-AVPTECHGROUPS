            ...
            <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {statsLoading ? (
                        ...
                        <>
                            <CardComponent IconName={GraduationCap} keyName="Total Students" val={`${stats?.totalStudents ?? 0} registered`} iconTxColor="text-blue-600" iconBgColor="bg-blue-100" />
                            <CardComponent IconName={UserCheck} keyName="Students Enrolled" val={`${stats?.studentsEnrolled ?? 0} of ${stats?.totalStudents ?? 0}`} iconTxColor="text-emerald-600" iconBgColor="bg-emerald-100" />
                            <CardComponent IconName={UserX} keyName="Not Enrolled" val={`${(stats?.totalStudents ?? 0) - (stats?.studentsEnrolled ?? 0)} pending`} iconTxColor="text-red-500" iconBgColor="bg-red-100" />
