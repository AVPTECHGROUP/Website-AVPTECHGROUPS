    ...
    return (
        <div className="flex items-center justify-between gap-3">
            <button type="button" onClick={onBack} disabled={submitting || previewLoading}
                className="px-6 py-2.5 text-sm cursor-pointer font-semibold text-gray-600 border border-gray-200 rounded-xl hover:bg-gray-100 transition-colors disabled:opacity-50">
                ← Back
            </button>
...
export default function EditStudentOrder() {
    ...
    if (!editOrderId) {
        return (
            <div className="min-h-screen bg-linear-to-b from-sky-50 to-sky-100 flex items-center justify-center">
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-5">
                                ...
                                <div className="space-y-2">
                                    ...
                                    {selectedStudent ? (
                                        <div onClick={() => setSelectedStudent(null)}
                                            ...
                                            <span className="text-xs font-semibold text-blue-500 border border-blue-300 px-3 py-1 rounded-lg hover:bg-blue-100 transition-colors">Change</span>
                                        </div>
                                    ) : (
                                        <>
                                ...
                                <div className="flex justify-between pt-4 border-t border-gray-100">
                                    ...
                                    <button type="button" onClick={goNext}
                                        className="flex items-center gap-2 cursor-pointer bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold px-7 py-2.5 rounded-xl transition-colors shadow-sm">
                                        Next →
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-5">
                                ...
                                {hasAnyIssue && !previewLoading && (
                                    <div className="flex items-start gap-2 bg-orange-50 border border-orange-300 rounded-xl px-4 py-3 text-xs text-orange-800">
                                        ...
                                        <div>
                                            ...
                                            <p>Some item quantities exceed available stock. Reduce them to proceed to Confirm. You can still <strong>Save as Draft</strong> with current quantities.</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                                    <button type="button" onClick={goBack} disabled={submitting}
                                        className="px-6 py-2.5 cursor-pointer text-sm font-semibold text-gray-600 border border-gray-200 rounded-xl hover:bg-gray-100 transition-colors disabled:opacity-50">
                                        ← Back
                                    </button>
                                    <div className="flex items-center gap-3">
